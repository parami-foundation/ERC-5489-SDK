              ...
              <div className={styles.adDescription}>
                ...
                <div className={styles.rewardAmount}>
                  ...
                  {ad.governanceTokenInfo?.priceInfo && <>
                    <div className={`${styles.tokenPriceInfo}`} onClick={() => {
                      if (ad.governanceTokenInfo?.priceInfo?.dexPoolUrl) {
                        window.open(ad.governanceTokenInfo?.priceInfo?.dexPoolUrl, '_blank');
                      }
                    }}>
